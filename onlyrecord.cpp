...
public:
    AudioRecorder(juce::AudioThumbnail &thumbnailToUpdate) : thumbnail(thumbnailToUpdate) { backgroundThread.startThread(); }
...
int main(int argc, char *argv[]) {
    ...
    if (audioRecorder.get() == nullptr) { audioRecorder.reset(new AudioRecorder(thumbnail)); }
